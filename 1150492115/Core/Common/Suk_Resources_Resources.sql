...
INSERT INTO Resource_ValidFeatures
			(ResourceType,					FeatureType)
SELECT		'RESOURCE_SUK_SHARK',			'FEATURE_REEF'
WHERE EXISTS (SELECT * FROM Features WHERE FeatureType = 'FEATURE_REEF');
-------------------------------------
-- Resource_Harvests
-------------------------------------
...
VALUES	('IMPROVEMENT_PASTURE',			'RESOURCE_SUK_CHEESE',				0),
		('IMPROVEMENT_PASTURE',			'RESOURCE_SUK_CAMEL',				0),

		('IMPROVEMENT_QUARRY',			'RESOURCE_SUK_OBSIDIAN',			0),

		('IMPROVEMENT_FISHING_BOATS',	'RESOURCE_SUK_SHARK',				0),

		('IMPROVEMENT_CAMP',			'RESOURCE_DLV_BISON',				0);
--==========================================================================================================================
--==========================================================================================================================