...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_R6_MITHRAISM'),  	('en_US'),			('Sol Invictus')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_JULIUS_MODERN' AND Value = 2);
...
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_LEGALISM' AND Value = 3);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_G8'),  	('en_US'),			('State Atheism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_KUBLAI_CHINA_TENGRIISM' AND Value = 4);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_G8'),  	('en_US'),			('State Atheism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 4);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_G8'),  	('en_US'),			('State Atheism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 4);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_G8'),  	('en_US'),			('State Atheism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_UNIFIER' AND Value = 3);
...
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_NORSE_RELIGIONS' AND Value = 1);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_I5_TWELVER'),  	('en_US'),			('Imami')
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_I5_TWELVER'),  	('en_US'),			('Imami Islam')
...
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_TWELVER' AND Value = 3);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_I5_TWELVER'),  	('en_US'),			('Jafari')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_TWELVER' AND Value = 4);
...
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_TWELVER' AND Value = 5);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_MORMONISM'),  	('en_US'),			('Mormons')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_MORMONISM' AND Value = 2);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_C1_ORIENTAL'),  	('en_US'),			('Tewahedo Church')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_ORIENTAL' AND Value = 3);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_P7_QUAKER'),  	('en_US'),			('Quakers')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_QUAKER' AND Value = 2);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_VOODOO'),  	('en_US'),			('Hoodoo')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_VOODOO' AND Value = 2);
...
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_FIVER' AND Value = 3);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_P2_BAPTIST'),  	('en_US'),			('Baptist Faith')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_BAPTISTISM' AND Value = 1);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_P2_BAPTIST'),  	('en_US'),			('Baptistism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_BAPTISTISM' AND Value = 2);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_P2_BAPTIST'),  	('en_US'),			('Baptists')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_BAPTISTISM' AND Value = 3);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_I7_ISMAILI'),  	('en_US'),			('Sevener')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_ISMAILI' AND Value = 3);
...
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_AHMADI' AND Value = 2);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_I8_ALI'),  	('en_US'),			('Alawi')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_ALAWIYAH' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_I8_ALI'),  	('en_US'),			('Alawi Islam')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_ALAWIYAH' AND Value = 2);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_AITO'),  	('en_US'),			('Bathalism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_ANITO' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_AITO'),  	('en_US'),			('Dayawism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_ANITO' AND Value = 2);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_MOHISM'),  	('en_US'),			('Mojia')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_MOHISM' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_TAOISM'),  	('en_US'),			('Daoism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_TAOISM' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_TAOISM'),  	('en_US'),			('Daojia')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_TAOISM' AND Value = 2);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_CONFUCIANISM'),  	('en_US'),			('Ruism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_CONFUCIAN' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_CONFUCIANISM'),  	('en_US'),			('Rujia')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_CONFUCIAN' AND Value = 2);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_T1_SHENISM'),  	('en_US'),			('Shendao')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_SHEN' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_R4_NUMENISM'),  	('en_US'),			('Religio')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_NUMEN' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_R4_NUMENISM'),  	('en_US'),			('Cultus Deorum')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_NUMEN' AND Value = 2);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_R2_MYSTERIES'),  	('en_US'),			('Eleusinian Mysteries')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_MYSTERY' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_R2_MYSTERIES'),  	('en_US'),			('Dionysian Mysteries')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_MYSTERY' AND Value = 2);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_R2_MYSTERIES'),  	('en_US'),			('Orphism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_MYSTERY' AND Value = 3);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_R7_HEROS_CULT'),  	('en_US'),			('Sabazios Cult')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_HEROS' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_SMANISM'),  	('en_US'),			('Shamanism')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_SAMANISM' AND Value = 1);

--

INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_RELIGION_NMMO'),  	('en_US'),			('Nommo')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_MALI_HR' AND Value = 1);
...
INSERT OR REPLACE INTO LocalizedText
		(Tag, 							Language,					Text)
SELECT  ('LOC_PEDIA_RELIGIONS_PAGE_RELIGION_G8_CHAPTER_HISTORY_PARA_1'),  	('en_US'),			('Atheism is not a religion or organized philosophy in and of itself, but rather the absence of belief in the existence of deities. More broadly, it is also used to refer to the rejection of religion in general and thus still presented in contrast to even nontheistic religions. However, when incorporated into political regimes it can form the basis of an organized political ideology oftentimes dedicated to systematic secularization attempts by the state.')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NAMING_ATOM_ICON' AND Value = 1);
