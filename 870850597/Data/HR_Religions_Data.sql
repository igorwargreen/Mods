...
SELECT  	('RELIGION_P2_BAPTIST'),  					('KIND_RELIGION')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_LITE_COMPLETE_SWITCH' AND Value = 0)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_BAPTIST_LITE_EXCEPTION' AND Value = 1);
...
SELECT  	('RELIGION_R4_NUMENISM'),  							('KIND_RELIGION')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_LITE_COMPLETE_SWITCH' AND Value = 0)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NUMEN_LITE_EXCEPTION' AND Value = 1);
...
SELECT  	('RELIGION_NMMO'),  					('KIND_RELIGION')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_LITE_COMPLETE_SWITCH' AND Value = 0)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NOMMO_LITE_EXCEPTION' AND Value = 1);
...
SELECT  	('RELIGION_C0_CATHOLICISM'),  						('KIND_RELIGION')
WHERE EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_LITE_COMPLETE_SWITCH' AND Value = 0)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_ALT_CATHOLICISM_EXCEPTION' AND Value = 1);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_ABRAHAM_LINCOLN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_ABRAHAM_LINCOLN');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_ABRAHAM_LINCOLN'),  								('RELIGION_PROTESTANTISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_ABRAHAM_LINCOLN');
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_ABRAHAM_LINCOLN'),  								('RELIGION_P2_BAPTIST')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_ABRAHAM_LINCOLN')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_P2_BAPTIST');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_ABRAHAM_LINCOLN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_ABRAHAM_LINCOLN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_LINCOLN_ATHEISM' AND Value = 1);

--

CREATE TRIGGER DLCLincolnHR
AFTER INSERT ON FavoredReligions WHEN 'LEADER_SALADIN_ALT' = NEW.LeaderType
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_BASIL'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_BASIL')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_BASIL_CATHOLICISM' AND Value = 2);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_BASIL'),  								('RELIGION_ISLAM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_BASIL')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_BASIL_CATHOLICISM' AND Value = 2);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_CHANDRAGUPTA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_CHANDRAGUPTA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CHANDRAGUPTA_JAINISM' AND Value = 2);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_CLEOPATRA_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_CLEOPATRA_ALT');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_CLEOPATRA_ALT'),  							('RELIGION_HELLENISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_CLEOPATRA_ALT');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_CLEOPATRA_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_CLEOPATRA_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CLEOPATRA_ALT_HELLENISM' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_CLEOPATRA_ALT'),  								('RELIGION_PESEDJET')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_CLEOPATRA_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CLEOPATRA_ALT_HELLENISM' AND Value = 1);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_CLEOPATRA_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_CLEOPATRA_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CLEOPATRA_ALT_HELLENISM' AND Value = 2);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_CLEOPATRA_ALT'),  						    		('RELIGION_ISLAM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_CLEOPATRA_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CLEOPATRA_ALT_HELLENISM' AND Value = 2);

--

CREATE TRIGGER DLCCleoAltHR
AFTER INSERT ON HistoricalAgendas WHEN 'LEADER_CLEOPATRA_ALT' = NEW.LeaderType
BEGIN
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_DIDO'),  						    		('RELIGION_R4_NUMENISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_DIDO')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CARTHAGE_LEBANON' AND Value = 1)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_R4_NUMENISM');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_DIDO'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_DIDO')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CARTHAGE_LEBANON' AND Value = 3);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_DIDO'),  						    		('RELIGION_JUDAISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_DIDO')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CARTHAGE_LEBANON' AND Value = 3);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_DIDO'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_DIDO')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CARTHAGE_LEBANON' AND Value = 4);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_ELIZABETH'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_ELIZABETH');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_ELIZABETH'),  							('RELIGION_PROTESTANTISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_ELIZABETH');
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_ELIZABETH'),  								('RELIGION_C3_ANGLICANISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_ELIZABETH')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_C3_ANGLICANISM');

--

CREATE TRIGGER DLCElizabethEnglandHR
AFTER INSERT ON RequirementSets WHEN 'BUILDING_IS_POWER_PLANT_ENGLAND' = NEW.RequirementSetId
BEGIN
...
--------------- Harald Hardrada (Varangian Alt)

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_HARALD_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_HARALD_ALT');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_HARALD_ALT'),  							('RELIGION_ORTHODOXY')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_HARALD_ALT');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_HARALD_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_HARALD_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_HARDRADA_VARANGIAN_FORN_SIDR' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_HARALD_ALT'),  								('RELIGION_CATHOLICISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_HARALD_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_HARDRADA_VARANGIAN_FORN_SIDR' AND Value = 1);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_HARALD_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_HARALD_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_HARDRADA_VARANGIAN_FORN_SIDR' AND Value = 2)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_FORN_SIDR');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_HARALD_ALT'),  								('RELIGION_FORN_SIDR')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_HARALD_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_HARDRADA_VARANGIAN_FORN_SIDR' AND Value = 2)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_FORN_SIDR');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_HARALD_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_HARALD_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_HARDRADA_VARANGIAN_FORN_SIDR' AND Value = 3);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_HARALD_ALT'),  								('RELIGION_PROTESTANTISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_HARALD_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_HARDRADA_VARANGIAN_FORN_SIDR' AND Value = 3);

--

CREATE TRIGGER DLCVarangianHaraldHR
AFTER INSERT ON RequirementSets WHEN 'BUILDING_IS_POWER_PLANT_ENGLAND' = NEW.RequirementSetId
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_JULIUS_CAESAR'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_JULIUS_CAESAR');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_JULIUS_CAESAR'),  							('RELIGION_HELLENISM')
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_JULIUS_CAESAR'),  								('RELIGION_R4_NUMENISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_JULIUS_CAESAR')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_R4_NUMENISM');
...
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_JULIUS_CAESAR')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_R5_IMPERIAL_CULT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_JULIUS_MODERN' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_JULIUS_CAESAR'),  								('RELIGION_R5_IMPERIAL_CULT')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_JULIUS_CAESAR')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_R5_IMPERIAL_CULT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_JULIUS_MODERN' AND Value = 1);
...
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_JULIUS_MODERN' AND Value = 2);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_JULIUS_CAESAR'),  								('RELIGION_R6_MITHRAISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_JULIUS_CAESAR')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_R6_MITHRAISM')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_JULIUS_MODERN' AND Value = 2);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_JULIUS_CAESAR'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_JULIUS_CAESAR')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_JULIUS_MODERN' AND Value = 3);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_JULIUS_CAESAR'),  						    		('RELIGION_CATHOLICISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_JULIUS_CAESAR')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_JULIUS_MODERN' AND Value = 3);

--

CREATE TRIGGER DLCJuliusHR
AFTER INSERT ON HistoricalAgendas WHEN 'LEADER_JULIUS_CAESAR' = NEW.LeaderType
BEGIN
...
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_KUBLAI_KHAN_CHINA'),  								('RELIGION_T1_SHENISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_KUBLAI_KHAN_CHINA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_KUBLAI_CHINA_TENGRIISM' AND Value = 2)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_KUBLAI_KHAN_CHINA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_KUBLAI_KHAN_CHINA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_KUBLAI_CHINA_TENGRIISM' AND Value = 5);
...
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_LUDWIG');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  ('LEADER_LUDWIG'),  						    ('RELIGION_CATHOLICISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_LUDWIG');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_LUDWIG'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_LUDWIG')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_LUDWIG_MODERN' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_LUDWIG'),  						    		('RELIGION_PROTESTANTISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_LUDWIG')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_LUDWIG_MODERN' AND Value = 1);

--

CREATE TRIGGER DLCLudwigHR1
AFTER INSERT ON HistoricalAgendas WHEN 'LEADER_LUDWIG' = NEW.LeaderType
BEGIN
...
CREATE TRIGGER DLCLudwigHR2
AFTER INSERT ON Leaders WHEN 'LEADER_SEJONG' = NEW.LeaderType
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_NADER_SHAH'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NADER_SHAH');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_NADER_SHAH'),  								('RELIGION_ISLAM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NADER_SHAH');
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_NADER_SHAH'),  								('RELIGION_I1_SHIA')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NADER_SHAH')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_I1_SHIA');
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_NADER_SHAH'),  								('RELIGION_I5_TWELVER')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NADER_SHAH')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_I5_TWELVER');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_NADER_SHAH'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NADER_SHAH')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NADER_SUNNI' AND Value = 1);
...
CREATE TRIGGER DLCNaderDLC
AFTER INSERT ON FavoredReligions WHEN 'LEADER_SULEIMAN_ALT' = NEW.LeaderType
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_NZINGA_MBANDE'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NZINGA_MBANDE');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_NZINGA_MBANDE'),  								('RELIGION_CATHOLICISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NZINGA_MBANDE');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_NZINGA_MBANDE'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NZINGA_MBANDE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NZINGA_MBANDE_MODERN' AND Value = 0)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_NZAMBIISM');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_NZINGA_MBANDE'),  								('RELIGION_NZAMBIISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_NZINGA_MBANDE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NZINGA_MBANDE_MODERN' AND Value = 0)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_NZAMBIISM');

CREATE TRIGGER DLCNzingaHR
AFTER INSERT ON FavoredReligions WHEN 'LEADER_SALADIN_ALT' = NEW.LeaderType
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_QIN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_LEGALISM' AND Value = 1)
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_QIN'),  								('RELIGION_T1_SHENISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_LEGALISM' AND Value = 2)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_QIN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_LEGALISM' AND Value = 4);

--------------- Qin Alt

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_QIN_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_QIN_ALT'),  							('RELIGION_TAOISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_QIN_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_UNIFIER' AND Value = 0)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_Q7_LEGALISM');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_QIN_ALT'),  								('RELIGION_Q7_LEGALISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_UNIFIER' AND Value = 0)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_Q7_LEGALISM');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_QIN_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_UNIFIER' AND Value = 2)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_QIN_ALT'),  								('RELIGION_T1_SHENISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_UNIFIER' AND Value = 2)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_QIN_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_UNIFIER' AND Value = 3)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_G8');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_QIN_ALT'),  								('RELIGION_G8')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_UNIFIER' AND Value = 3)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_G8');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_QIN_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_QIN_ALT')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_QIN_UNIFIER' AND Value = 4);

--

CREATE TRIGGER DLCQinUnifierHR
AFTER INSERT ON Projects WHEN 'PROJECT_LIJIA_FAITH' = NEW.ProjectType
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_RAMSES'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_RAMSES');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_RAMSES'),  							('RELIGION_PESEDJET')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_RAMSES');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_RAMSES'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_RAMSES')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_RAMSES_MODERN' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_RAMSES'),  						    		('RELIGION_ISLAM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_RAMSES')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_RAMSES_MODERN' AND Value = 1);

--

CREATE TRIGGER DLCRamsesHR
AFTER INSERT ON HistoricalAgendas WHEN 'LEADER_RAMSES' = NEW.LeaderType
BEGIN
...
--DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_SALADIN_ALT'
--AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SALADIN_ALT');
--
--INSERT OR REPLACE INTO FavoredReligions 
--		(LeaderType, 									ReligionType)
--SELECT  ('LEADER_SALADIN_ALT'),  								('RELIGION_ISLAM')
--WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SALADIN_ALT');

--------------- Sejong

--DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_SEJONG'
--AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SEJONG');
--
--INSERT OR REPLACE INTO FavoredReligions 
--		(LeaderType, 									ReligionType)
--SELECT  	('LEADER_SEJONG'),  							('RELIGION_CONFUCIANISM')
--WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SEJONG');

CREATE TRIGGER DLCSejongAltHR
AFTER INSERT ON RequirementSets WHEN 'BUILDING_IS_POWER_PLANT_ENGLAND' = NEW.RequirementSetId
BEGIN
	...
	DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_SEJONG'
	AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SEJONG')
	AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_SEJONG_MODERN' AND Value = 1)
	AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_BUDDHISM');

	INSERT OR REPLACE INTO FavoredReligions 
			(LeaderType, 									ReligionType)
	SELECT  	('LEADER_SEJONG'),  								('RELIGION_BUDDHISM')
	WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SEJONG')
	AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_SEJONG_MODERN' AND Value = 1)
	AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_BUDDHISM');
	...
	INSERT OR REPLACE INTO FavoredReligions 
			(LeaderType, 									ReligionType)
	SELECT  	('LEADER_SEJONG'),  								('RELIGION_B1_MAHAYANA')
	WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SEJONG')
	AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_SEJONG_MODERN' AND Value = 1)
	AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_B1_MAHAYANA');
	...
	DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_SEJONG'
	AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SEJONG')
	AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_SEJONG_MODERN' AND Value = 2)
	AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_MUISM');

	INSERT OR REPLACE INTO FavoredReligions 
			(LeaderType, 									ReligionType)
	SELECT  	('LEADER_SEJONG'),  								('RELIGION_MUISM')
	WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SEJONG')
	AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_SEJONG_MODERN' AND Value = 2)
	AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_MUISM');
	...
	DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_SEJONG'
	AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SEJONG')
	AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_SEJONG_MODERN' AND Value = 3);
...
--DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_SULEIMAN_ALT'
--AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SULEIMAN_ALT');
--
--INSERT OR REPLACE INTO FavoredReligions 
--		(LeaderType, 									ReligionType)
--SELECT  ('LEADER_SULEIMAN_ALT'),  								('RELIGION_ISLAM')
--WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SULEIMAN_ALT');

--------------- Sundiata Keita

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_SUNDIATA_KEITA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SUNDIATA_KEITA');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_SUNDIATA_KEITA'),  								('RELIGION_ISLAM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SUNDIATA_KEITA');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_SUNDIATA_KEITA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SUNDIATA_KEITA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_MALI_INDIG' AND Value = 0)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_NMMO');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_SUNDIATA_KEITA'),  								('RELIGION_NMMO')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_SUNDIATA_KEITA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_MALI_INDIG' AND Value = 0)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_NMMO');
...
CREATE TRIGGER DLCSundiataHR
AFTER INSERT ON Traits WHEN 'TRAIT_LEADER_SUNDIATA_KEITA' = NEW.TraitType
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_THEODORA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_THEODORA');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_THEODORA'),  								('RELIGION_C1_ORIENTAL')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_THEODORA');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_THEODORA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_THEODORA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_THEODORA_MODERN' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_THEODORA'),  						    		('RELIGION_ORTHODOXY')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_THEODORA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_THEODORA_MODERN' AND Value = 1);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_THEODORA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_THEODORA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_THEODORA_MODERN' AND Value = 2);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_THEODORA'),  						    		('RELIGION_CATHOLICISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_THEODORA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_THEODORA_MODERN' AND Value = 2);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_THEODORA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_THEODORA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_THEODORA_MODERN' AND Value = 3);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_THEODORA'),  						    		('RELIGION_ISLAM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_THEODORA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_THEODORA_MODERN' AND Value = 3);

--

CREATE TRIGGER DLCTheodoraHR1
AFTER INSERT ON HistoricalAgendas WHEN 'LEADER_THEODORA' = NEW.LeaderType
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_TOKUGAWA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_TOKUGAWA');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_TOKUGAWA'),  								('RELIGION_SHINTO')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_TOKUGAWA');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_TOKUGAWA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_TOKUGAWA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_TOKUGAWA_SHINTO' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_TOKUGAWA'),  								('RELIGION_CONFUCIANISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_TOKUGAWA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_TOKUGAWA_SHINTO' AND Value = 1);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_TOKUGAWA'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_TOKUGAWA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_TOKUGAWA_SHINTO' AND Value = 2);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_TOKUGAWA'),  								('RELIGION_BUDDHISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_TOKUGAWA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_TOKUGAWA_SHINTO' AND Value = 2);
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  ('LEADER_TOKUGAWA'),  								('RELIGION_B1_MAHAYANA')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_TOKUGAWA')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_B1_MAHAYANA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_TOKUGAWA_SHINTO' AND Value = 2);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_VICTORIA_ALT'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_VICTORIA_ALT');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 								 	ReligionType)
SELECT  	('LEADER_VICTORIA_ALT'),  							('RELIGION_PROTESTANTISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_VICTORIA_ALT');
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_VICTORIA_ALT'),  								('RELIGION_C3_ANGLICANISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_VICTORIA_ALT')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_C3_ANGLICANISM');

--

CREATE TRIGGER DLCVictoriaAltHR
AFTER INSERT ON RequirementSets WHEN 'BUILDING_IS_POWER_PLANT_ENGLAND' = NEW.RequirementSetId
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_WU_ZETIAN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_WU_ZETIAN'),  								('RELIGION_BUDDHISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN');
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_WU_ZETIAN'),  								('RELIGION_B1_MAHAYANA')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_B1_MAHAYANA');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_WU_ZETIAN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_WU_ZETIAN'),  								('RELIGION_CONFUCIANISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 1);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_WU_ZETIAN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 2);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_WU_ZETIAN'),  								('RELIGION_TAOISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 2);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_WU_ZETIAN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 3)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_WU_ZETIAN'),  								('RELIGION_T1_SHENISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 3)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_WU_ZETIAN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 4)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_G8');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_WU_ZETIAN'),  								('RELIGION_G8')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 4)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_G8');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_WU_ZETIAN'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_WU_ZETIAN')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_WU_ALT' AND Value = 5);

--

CREATE TRIGGER DLCWuHR
AFTER INSERT ON Projects WHEN 'PROJECT_LIJIA_FAITH' = NEW.ProjectType
BEGIN
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_YONGLE'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_YONGLE'),  								('RELIGION_CONFUCIANISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE');

--

DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_YONGLE'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 1);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_YONGLE'),  								('RELIGION_TAOISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 1);
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_YONGLE'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 2);

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_YONGLE'),  								('RELIGION_BUDDHISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 2);
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_YONGLE'),  								('RELIGION_B1_MAHAYANA')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 2)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_B1_MAHAYANA');
...
INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_YONGLE'),  								('RELIGION_B2_VAJRAYANA')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 2)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_B2_VAJRAYANA');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_YONGLE'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 3)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_YONGLE'),  								('RELIGION_T1_SHENISM')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 3)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_T1_SHENISM');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_YONGLE'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 4)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_G8');

INSERT OR REPLACE INTO FavoredReligions 
		(LeaderType, 									ReligionType)
SELECT  	('LEADER_YONGLE'),  								('RELIGION_G8')
WHERE EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 4)
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_G8');
...
DELETE FROM FavoredReligions WHERE LeaderType = 'LEADER_YONGLE'
AND EXISTS (SELECT * FROM Leaders WHERE LeaderType = 'LEADER_YONGLE')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_YONGLE_ALT' AND Value = 5);

--

CREATE TRIGGER DLCYongleHR
AFTER INSERT ON Projects WHEN 'PROJECT_LIJIA_FAITH' = NEW.ProjectType
BEGIN
...
UPDATE Religions
SET RequiresCustomName = 0
WHERE ReligionType = 'RELIGION_NMMO'
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_NMMO')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CUSTOM_NAMES' AND Value = 1)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_MALI_INDIG' AND Value = 0);
...
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_B2_VAJRAYANA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CUSTOM_NAMES' AND Value = 1)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_KUBLAI_CHINA_TENGRIISM' AND Value = 0);
...
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CUSTOM_NAMES' AND Value = 1)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CYRUS_MODERN' AND Value = 1)
AND NOT EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_I5_TWELVER');
...
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_R4_NUMENISM')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CUSTOM_NAMES' AND Value = 1)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_JULIUS_MODERN' AND Value = 0);
...
AND EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_I1_SHIA')
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_CUSTOM_NAMES' AND Value = 1)
AND EXISTS (SELECT * FROM HR_Denominations WHERE Type = 'HR_NADER_SUNNI' AND Value = 0)
AND NOT EXISTS (SELECT * FROM Religions WHERE ReligionType = 'RELIGION_I5_TWELVER');
...
--------
-- New Icons:
---- Ajivika  - Ascetic Prayiing
---- Alawiyah - Alawite State Flag Star
---- Yazidism - Peacock
---- Shaivism - Trident from Scenario
---- Manichaeism - Something New
--------
-- New Religions:
---- Samaritanism - Jewish Denom
---- Starovery / E. Orthodox Old Believers - E. Orthodox Denom
---- Ainu Religion ?
---- Orphism / Mysteries Split ?
---- Middle Mississippian ?
---- That Atheist Ancient Indian One
--------
---- Zen seperate?
--------
...
---- Remove Mutzil
--------
---- Option to increase number of religions
--------
---- Rename Mushrikun to Wathanism
--------
---- Pedia for Mandinka/Dogon seperate
----
---- In the traditional Mandinka religion, God is called Maa Ngala. In the traditional religion, God being too high to be invoked directly, the ancestors and the spirits are the entities to which the prayers are addressed; they are the intermediaries between god and men. God is the great creator.
---- Among the Mandinka, the Komotigui (men or women) are those who have reached the highest level of spiritual knowledge. To become Komotigui, initiation is an obligatory condition. According to initiatory groups, Komo or Nama, the duration of the initiation is more or less long. In general it is a cycle of seven times seven years, then a new cycle of the same duration. To benefit from the blessings of the Creator, respect of forbidden and tribute to Maa Ngala are compulsory.
---- Prayers, offerings to the intermediate entities (ancestors and spirits), individually, in family, or during the different religious ceremonies, are the actions that punctuate the Mandinka spiritual life. Man is not considered as such if he has not gone through the rite of circumcision. In traditional spirituality, everything is governed according to the spiritual laws, from birth to death, where the soul of being has been exemplary on earth joined the world of God and ancestors.
---- Each family has its own animal totem, which is part of the respect for beings, creatures of God with the divine plot. It is according to the age classes Ton, that one learns the various aspects of the life, always according to the spiritual rules, in order to be an accomplished individual in the society.
---- Today, over 99% of Mandinka are Muslim. Some Mandinka syncretise Islam and traditional African religions. Among these syncretists spirits can be controlled mainly through the power of a marabout, who knows the protective formulas. In most cases, no important decision is made without first consulting a marabout. Marabouts, who have Islamic training, write Qur'anic verses on slips of paper and sew them into leather pouches (talisman); these are worn as protective amulets.
