...
VALUES	--('COLOR_RELIGION_AMATONGO',		0.894,			0.815,			0.039,		1),		
		...
		('COLOR_RELIGION_I2_IBADI',				0.054,			0.8,			0.95,		1),
		...
		('COLOR_RELIGION_OENDA',					0.3,			0.75,			0.85,		1),--		
		...
		('COLOR_RELIGION_NMMO',						0.275,			0.6,			0.9,		1),--	
		('COLOR_RELIGION_I5_TWELVER',						0.1,			0.582,			0.755,		1),	
