...
--	(Y,	/* -- --> Sunni																							*/--		'HR_ISLAM_1'),
	...
	(1,  	/* -- --- -- --> Ismailiyah			:: Sevener																	*/		'HR_ISMAILI'),
...
--	(X,	/* Judaism																							*/--		'HR_JUDAISM'),
	...
	(1,	/* Maa Ngala					:: Sahel (Mandinka, Dogon...)															*/		'HR_NOMMO'),
...
------------------------------------
-- Misc. Unused Religions & Denominations
------------------------------------
...
------------------------------------
-- Misc. Unused Custom Icons
------------------------------------

	----
	(0,	/* Unused "Face" Custom Icon																					*/		'HR_FACE'),
	----														
	(0,	/* Unused "Catholicism" Custom Icon																				*/		'HR_ALT_CATHOLICISM'),
	(0,	/* Unused "Rodnovery" Custom Icon																				*/		'HR_ALT_RODNOVERY'),
	(0,	/* Unused "Ayni" Custom Icon																					*/		'HR_ALT_PACHAISM'),
	(0,	/* Unused "Manichaeaism" Custom Icon																				*/		'HR_ALT_MANICHAEAISM'),
	----
...
-- options listed above and can be activated independently of each other and their base religion. This option group is not meant to be exhaustive, but rather facilitate the 
...
------------------------------------
	...
	(0,	/* Maa Ngala		:: 1 = Loads Maa Ngala when Lite Mode is enabled															*/		'HR_NOMMO_LITE_EXCEPTION'),	
...
------------------------------------
	...
	(0,	/* Baptist Christianity	:: 1 = Loads Baptist Christianity (Protestantism changes to Lutheranism) when Lite Mode is enabled 									*/		'HR_BAPTIST_LITE_EXCEPTION'),
	...
	(0,	/* Numenism		:: 1 = Loads Numenism (Hellenism changes to Dodekatheon) when Lite Mode is enabled											*/		'HR_NUMEN_LITE_EXCEPTION'),
...
-- Additional religions can be added to Lite Mode using the 'Lite Mode Exceptions' section above.
--
...
------------------------------------
	...
	(0,	/* Basil		 :: 0 = Eastern Orthodoxy, 1 = Catholicism			[TURKEY]: 2 = Islam (Sunni)										*/		'HR_BASIL_CATHOLICISM'),	
	(0,	/* Chandragupta		 :: 0 = Jainism, 1 = Hinduism (Vedism)				[INDIA]: 2 = (Vaishnavism)										*/		'HR_CHANDRAGUPTA_JAINISM'),
	(0,	/* Cleopatra (Egyptian)	 :: 0 = Pesedjet, 1 = Hellenism (Dodekatheon) 			[EGYPT]: 2 = Islam (Sunni)										*/		'HR_CLEOPATRA_HELLENISM'),
	(0,	/* Cleopatra (Ptolemaic) :: 0 = Hellenism (Dodekatheon), 1 = Pesedjet  			[EGYPT]: 2 = Islam (Sunni)										*/		'HR_CLEOPATRA_ALT_HELLENISM'),
	(0,	/* Curtin		 :: 0 = Protestantism (Calvinism), 1 = None 																*/		'HR_CURTIN_ATHEISM'),
	(0,	/* Cyrus		 :: 0 = Zoroastrianism (Mazdayasna) 				[IRAN]: 1 = Islam (Shia [Imamiyah])									*/		'HR_CYRUS_MODERN'),
	(0,	/* Dido			 :: 0 = Canaanism 						[CARTHAGE]: 1 = Hellenism (Numenism), 2 = (Imperial Cult), [Levant]: 3 = Judaism, 4 = Islam (Sunni)	*/		'HR_CARTHAGE_LEBANON'),
	...
	(0,	/* Gilgamesh		 :: 0 = Chaldaeanism 						[IRAQ]: 1 = Islam (Shia [Imamiyah])									*/		'HR_GILGAMESH_IRAQ'),
	...
	(0,	/* Hammurabi		 :: 0 = Chaldaeanism 						[IRAQ]: 1 = Islam (Shia [Imamiyah])									*/		'HR_HAMMURABI_IRAQ'),	
	(0,	/* Hardrada (Konge)	 :: 0 = Eastern Orthodoxy, 1 = Catholicism 			[VIKING]: 2 = Forn Sidr, [NORWAY]: 3 = Protestantism (Lutheranism) 					*/		'HR_HARDRADA_FORN_SIDR_LUTHERANISM'),	
	(0,	/* Hardrada (Varangian)	 :: 0 = Eastern Orthodoxy, 1 = Catholicism 			[VIKING]: 2 = Forn Sidr, [NORWAY]: 3 = Protestantism (Lutheranism) 					*/		'HR_HARDRADA_VARANGIAN_FORN_SIDR'),			
	...
	(0,	/* Julius Caesar	 :: 0 = Hellenism (Numenism), 1 = (Imperial Cult)		[ROME]: 2 = (Sol Invictus), 3 = Catholicism								*/		'HR_JULIUS_MODERN'),
	(0,	/* Kristina		 :: 0 = Protestantism (Lutheranism), 1 = Catholicism															*/		'HR_KRISTINA_LUTHERANISM'),
	(0,	/* Kublai (Mongolia)	 :: 0 = Buddhism (Vajrayana) 					[MONGOLIA]: 1 = Tengriism										*/		'HR_KUBLAI_TENGRIISM'),	
	(0,	/* Kublai (China)	 :: 0 = Buddhism (Vajrayana) 					[MONGOLIA]: 1 = Tengriism, [CHINA]: 2 = Shenism, 3 = Taoism, 4 = State Atheism, 5 = None		*/		'HR_KUBLAI_CHINA_TENGRIISM'),
	...
	(0,	/* Lincoln		 :: 0 = Protestantism (Baptist), 1 = None 																*/		'HR_LINCOLN_ATHEISM'),
	(0,	/* Ludwig II		 :: 0 = Catholicism 						[GERMANY]: 1 = Protestantism (Lutheranism)								*/		'HR_LUDWIG_MODERN'),
	...
	(0,	/* Nader Shah		 :: 0 = Islam (Shia [Imamiyah]), 1 = (Sunni)																*/		'HR_NADER_SUNNI'),
	(0,	/* Nzinga Mbande	 :: 0 = Nzambiism, 1 = Catholicism 																	*/		'HR_NZINGA_MBANDE_MODERN'),
	...
	(0,	/* Qin (Mandate)	 :: 0 = Taoism, 1 = Legalism 					[CHINA]: 2 = Shenism, 3 = State Atheism, 4 = None							*/		'HR_QIN_LEGALISM'),
	(0,	/* Qin (Unifier)	 :: 0 = Legalism, 1 = Taoism 					[CHINA]: 2 = Shenism, 3 = State Atheism, 4 = None							*/		'HR_QIN_UNIFIER'),	
	(0,	/* Ramses		 :: 0 = Pesedjet 						[EGYPT]: 1 = Islam (Sunni)										*/		'HR_RAMSES_MODERN'),	
	(0,	/* Robert the Bruce	 :: 0 = Catholicism 						[SCOTLAND]: 1 = Protestantism (Calvinism)								*/		'HR_SCOTLAND_MODERN'),
	(0,	/* Sejong		 :: 0 = Confucianism, 1 = Buddhism (Mahayana)			[KOREA]: 2 = Mukyo, 3 = None 										*/		'HR_SEJONG_MODERN'),	
	...
	(0,	/* Sundiata Keita	 :: 0 = Maa Ngala, 1 = Islam (Sunni)																	*/		'HR_MALI_INDIG'),
	(0,	/* Theodora		 :: 0 = Oriental Orthodoxy, 1 = Eastern Orthodoxy, 2 = Catholic [TURKEY]: 3 = Islam (Sunni)										*/		'HR_THEODORA_MODERN'),
	(0,	/* Tokugawa		 :: 0 = Shinto, 1 = Confucianism, 2 = Buddhism (Mahayana)														*/		'HR_TOKUGAWA_SHINTO'),
	(0,	/* Tomyris		 :: 0 = Ardavda 						[CENTRAL ASIA]: 1 = Islam (Sunni)									*/		'HR_TOMYRIS_MODERN'),
	...
	(0,	/* Wu Zetian		 :: 0 = Buddhism (Mahayana), 1 = Confucianism, 2 = Taoism	[CHINA]: 3 = Shenism, 4 = State Atheism, 5 = None							*/		'HR_WU_ALT'),
	(0,	/* Yongle		 :: 0 = Confucianism, 1 = Taoism, 2 = Buddhism (Vajrayana)	[CHINA]: 3 = Shenism, 4 = State Atheism, 5 = None							*/		'HR_YONGLE_ALT'),
	----
...
------------------------------------
	...
	----
	(0,	/* Ahmadiyah		:: 0 = Ahmadiyah, 1 = Ahmadi, 2 = Ahmadi Islam 																*/		'HR_NAMING_AHMADI'),
	(0,	/* Alawiyah		:: 0 = Alawiyah, 1 = Alawi, 2 = Alawi Islam																*/		'HR_NAMING_ALAWIYAH'),
	...
	(0,	/* Baptist Christianity	:: 0 = Baptist Christianity, 1 = Baptist Faith, 2 = Baptistism														*/		'HR_NAMING_BAPTISTISM'),
	(0,	/* Calvinism		:: 0 = Calvinism, 1 = Reformed Protestantism, 2 = Presbyterianism													*/		'HR_NAMING_CALVINISM'),	
	(0,	/* Confucianism		:: 0 = Confucianism, 1 = Ruism, 2 = Rujia 																*/		'HR_NAMING_CONFUCIAN'),
	...
	(0,	/* Heros Cult		:: 0 = Heros Cult, 1 = Sabazios Cult																	*/		'HR_NAMING_HEROS'),	
	(0,	/* Ibadiyah		:: 0 = Ibadiyah, 1 = Ibadi, 2 = Ibadi Islam 																*/		'HR_NAMING_IBADI'),
	(0,	/* Ifa			:: 0 = Ifa, 1 = Itan																			*/		'HR_NAMING_IFA'),	
	(0,	/* Imamiyah		:: 0 = Imamiyah, 1 = Imami, 2 = Imami Islam, 3 = Ithnashariyah, 4 = Jafari, 5 = Twelver											*/		'HR_NAMING_TWELVER'),	
	(0,	/* Ismailiyah		:: 0 = Ismailiyah, 1 = Ismaili, 2 = Ismaili Islam, 3 = Sevener														*/		'HR_NAMING_ISMAILI'),	
	(0,	/* Latter-day Saints	:: 0 = Latter-day Saints, 1 = Mormonism																	*/		'HR_NAMING_MORMONISM'),
	(0,	/* Legalism		:: 0 = Legalism, 1 = Fajia																		*/		'HR_NAMING_LEGLISM'),
	(0,	/* Maa Ngala		:: 0 = Maa Ngala, 1 = Nommo																		*/		'HR_NAMING_MALI_HR'),
	...
	(0,	/* Mohism		:: 0 = Mohism, 1 = Mojia																		*/		'HR_NAMING_MOHISM'),
	(0,	/* Mukyo		:: 0 = Mukyo, 1 = Sinkyo																		*/		'HR_NAMING_MUKYO'),
	(0,	/* Mushrikun		:: 0 = Mushrikun, 1 = Wathanism																		*/		'HR_NAMING_ARABIC'),
	(0,	/* Mysteries		:: 0 = Mysteries, 1 = Eleusinian Mysteries, 2 = Dionysian Mysteries, 3 = Orphism											*/		'HR_NAMING_MYSTERY'),
	(0,	/* Nestorianism		:: 0 = Nestorianism, 1 = Church of the East																*/		'HR_NAMING_NESTORIANISM'),
	(0,	/* Numenism		:: 0 = Numenism, 1 = Religio, 2 = Cultus Deorum																*/		'HR_NAMING_NUMEN'),	
	(0,	/* Oriental Orthodoxy	:: 0 = Oriental Orthodoxy, 1 = Miaphysitism, 2 = Coptic Christianity, 3 = Tewahedo Church										*/		'HR_NAMING_ORIENTAL'),
	...
	(0,	/* Samanism		:: 0 = Samanism, 1 = Shamanism																		*/		'HR_NAMING_SAMANISM'),	
	(0,	/* Shenism		:: 0 = Shenism, 1 = Shendao	 																	*/		'HR_NAMING_SHEN'),
	...
	(0,	/* Taoism		:: 0 = Taoism, 1 = Daoism, 2 = Daojia 																	*/		'HR_NAMING_TAOISM'),
	(0,	/* Voodoo		:: 0 = Voodoo, 1 = Vodun, 2 = Hoodoo																	*/		'HR_NAMING_VOODOO'),
	...
	(0,	/* Zaidiyah		:: 0 = Zaidiyah, 1 = Zaidi, 2 = Zaidi Islam, 3 = Fiver															*/		'HR_NAMING_FIVER'),
	----
